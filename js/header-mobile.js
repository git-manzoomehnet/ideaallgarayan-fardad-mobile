...
innerOpen.forEach((element) => {
  element.addEventListener("click", function (params) {
    ...
    element.parentElement.parentElement.parentElement
      .querySelector(".innerMega2")
      .classList.toggle("openinnerMegaList");
...
let closeSearch = document.querySelector(".innerSearch .close")
searchIcon.addEventListener("click" , function(params) {
    searchContainer.classList.add("openModal")
})
closeSearch.addEventListener("click" , function(params) {
    searchContainer.classList.remove("openModal")
})